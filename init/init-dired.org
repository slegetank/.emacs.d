...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'dired-mode-hook (lambda ()
                               (evil-define-key '(motion normal) 'dired-mode-map (kbd "e") 'wdired-change-to-wdired-mode)
                               (evil-define-key '(motion normal) 'dired-mode-map (kbd "H") 'custom-dired-temp-hide-files)
                               (evil-define-key '(motion normal) 'dired-mode-map (kbd "O") 'custom-dired-open-file-with-osx)
                               (evil-define-key '(motion normal) 'dired-mode-map (kbd "s") 'custom-dired-sort-next)))
#+END_SRC
** copy recent
#+BEGIN_SRC emacs-lisp

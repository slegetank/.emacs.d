...
#+BEGIN_SRC emacs-lisp
  ...
  (slegetank/leader-define-key "wv"  (split-window-func-with-other-buffer 'split-window-vertically) "Split horizontally"
                               "ws" (split-window-func-with-other-buffer 'split-window-horizontally) "Split vertically")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (slegetank/leader-define-key "wb" 'swap-buffers "Swap buffers to another window")
#+END_SRC

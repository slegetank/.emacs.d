    ...
    (setq org-publish-project-alist
          `(
            ("blog-home"
             ...
             :exclude "org/*.*\\|README.org\\|draft/*.*"
             )
            ("blog-content"
             :base-directory ,(concat my-blog-post-base "/org")
             :base-extension "org"
             :publishing-directory ,(concat my-blog-publish-base "/org")
             :publishing-function (org-html-publish-to-html)
    ...
    (defun custom-blog-org-file-p ()
      ...
      (and (buffer-file-name)
           (or (s-suffix? "/draft/" (file-name-directory (buffer-file-name)))
               (s-suffix? "/org/" (file-name-directory (buffer-file-name))))
...
#+BEGIN_SRC emacs-lisp
  (defun custom-blog-publish ()
    ...
    (if (custom-blog-org-file-p)
        (progn (dired-rename-file (buffer-file-name) (concat my-blog-post-base "/org/" (file-name-nondirectory (buffer-file-name))) 1)
